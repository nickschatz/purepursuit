...
def test_distance():
    p1 = pursuit.Vector2(0, 0)
    p2 = pursuit.Vector2(1, 0)
    p3 = pursuit.Vector2(3, 4)
...
def test_translate():
    ...
    p1 = pursuit.Vector2(2, 2)
    p2 = pursuit.Vector2(2, 1)
    pose2 = pursuit.Pose(1, 1, math.pi / 4)
    assert eq_epsilon(p1.translated(pose), pursuit.Vector2(1, 1))
    assert eq_epsilon(p2.translated(pose), pursuit.Vector2(1, 0))
    assert eq_epsilon(p1.translated(pose2), pursuit.Vector2(0, 2 ** 0.5))
